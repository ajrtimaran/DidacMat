...
public class Fraccionar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fraccionar);
    ...
    public void respuestadividir (View v){

        nuevaFraccionar();
    }

    public void nuevaFraccionar(){
        int n1;
        int n2;
